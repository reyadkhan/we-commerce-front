<template>
    <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
        ...
        <div class="flex justify-center w-1/5">
            <svg v-if='$route.name === "carts"' class="fill-current text-gray-600 w-3 cursor-pointer" viewBox="0 0 448 512" @click='removeQuantity'>
                <path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/>
            </svg>

            <input class="mx-2 border text-center w-8" type="text" :value="cartProduct.quantity" readonly>

            <svg v-if='$route.name === "carts"' class="fill-current text-gray-600 w-3 cursor-pointer" viewBox="0 0 448 512" @click='addQuantity'>
