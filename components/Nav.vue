<template>
    <nav id="header" class="w-full z-30 top-0 py-1">
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
            ...
            <div id="menu" class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1">
                <nav>
                    <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                        <li><NuxtLink to='/' class="inline-block no-underline hover:text-black hover:underline py-2 px-4">Shop</NuxtLink></li>
                    </ul>
                </nav>
            </div>

            <div class="order-1 md:order-2">
                <NuxtLink to='/' class="flex items-center tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl">
            ...
            <div id="nav-content" class="order-2 md:order-3 flex items-center">
                ...
                <Logout v-else :home='true' />
                <NuxtLink class="pl-3 inline-block no-underline hover:text-black position relative" to='/carts'>
                    <svg class="fill-current hover:text-black" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
